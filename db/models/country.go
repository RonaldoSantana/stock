...
var (
	countryColumns               = []string{"id", "name", "iso_code_2", "iso_code_3", "status"}
	countryColumnsWithoutDefault = []string{"name", "iso_code_2", "iso_code_3"}
	countryColumnsWithDefault    = []string{"id", "status"}
...
func (o *Country) AddressesG(mods ...qm.QueryMod) addressQuery {
	return o.Addresses(boil.GetDB(), mods...)
}

// Addresses retrieves all the address's address with an executor.
func (o *Country) Addresses(exec boil.Executor, mods ...qm.QueryMod) addressQuery {
...
func (o *Country) GeoZoneMatricesG(mods ...qm.QueryMod) geoZoneMatrixQuery {
...
func (o *Country) GeoZoneMatrices(exec boil.Executor, mods ...qm.QueryMod) geoZoneMatrixQuery {
	queryMods := []qm.QueryMod{
		qm.Select("`a`.*"),
	}
...
// RegionsG retrieves all the region's region.
func (o *Country) RegionsG(mods ...qm.QueryMod) regionQuery {
	return o.Regions(boil.GetDB(), mods...)
}

// Regions retrieves all the region's region with an executor.
func (o *Country) Regions(exec boil.Executor, mods ...qm.QueryMod) regionQuery {
	queryMods := []qm.QueryMod{
		qm.Select("`a`.*"),
	}
	...
	queries.SetFrom(query.Query, "`region` as `a`")
	return query
}

// LoadAddresses allows an eager lookup of values, cached into the
// loaded structs of the objects.
func (countryL) LoadAddresses(e boil.Executor, singular bool, maybeCountry interface{}) error {
	var slice []*Country
	var object *Country
	...
	query := fmt.Sprintf(
		"select * from `address` where `country_id` in (%s)",
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.CountryID.Int {
...
// loaded structs of the objects.
func (countryL) LoadGeoZoneMatrices(e boil.Executor, singular bool, maybeCountry interface{}) error {
	var slice []*Country
	var object *Country
	...
	query := fmt.Sprintf(
		"select * from `geo_zone_matrix` where `country_id` in (%s)",
		strmangle.Placeholders(dialect.IndexPlaceholders, count, 1, 1),
	)
	if boil.DebugMode {
		fmt.Fprintf(boil.DebugWriter, "%s\n%v\n", query, args)
...
// loaded structs of the objects.
func (countryL) LoadRegions(e boil.Executor, singular bool, maybeCountry interface{}) error {
	var slice []*Country
	var object *Country
	...
	query := fmt.Sprintf(
		"select * from `region` where `country_id` in (%s)",
		strmangle.Placeholders(dialect.IndexPlaceholders, count, 1, 1),
	)
	if boil.DebugMode {
		fmt.Fprintf(boil.DebugWriter, "%s\n%v\n", query, args)
...
func (o *Country) AddAddressesG(insert bool, related ...*Address) error {
...
// Sets related.R.Country appropriately.
// Panics on error.
func (o *Country) AddAddressesP(exec boil.Executor, insert bool, related ...*Address) {
...
func (o *Country) AddAddressesGP(insert bool, related ...*Address) {
...
// Appends related to o.R.Addresses.
// Sets related.R.Country appropriately.
func (o *Country) AddAddresses(exec boil.Executor, insert bool, related ...*Address) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.CountryID.Int = o.ID
			rel.CountryID.Valid = true
...
// Uses the global database handle.
func (o *Country) SetAddressesG(insert bool, related ...*Address) error {
...
// Sets related.R.Country's Addresses accordingly.
// Panics on error.
func (o *Country) SetAddressesP(exec boil.Executor, insert bool, related ...*Address) {
...
// Sets related.R.Country's Addresses accordingly.
// Uses the global database handle and panics on error.
func (o *Country) SetAddressesGP(insert bool, related ...*Address) {
...
// Replaces o.R.Addresses with related.
// Sets related.R.Country's Addresses accordingly.
func (o *Country) SetAddresses(exec boil.Executor, insert bool, related ...*Address) error {
	query := "update `address` set `country_id` = null where `country_id` = ?"
...
// Uses the global database handle.
func (o *Country) RemoveAddressesG(related ...*Address) error {
...
// Sets related.R.Country.
// Panics on error.
func (o *Country) RemoveAddressesP(exec boil.Executor, related ...*Address) {
...
// Sets related.R.Country.
// Uses the global database handle and panics on error.
func (o *Country) RemoveAddressesGP(related ...*Address) {
...
// Removes related items from R.Addresses (uses pointer comparison, removal does not keep order)
// Sets related.R.Country.
func (o *Country) RemoveAddresses(exec boil.Executor, related ...*Address) error {
	var err error
	for _, rel := range related {
		rel.CountryID.Valid = false
		if rel.R != nil {
		...
		if err = rel.Update(exec, "country_id"); err != nil {
			return err
		}
	}
	if o.R == nil {
...
// Sets related.R.Country appropriately.
// Uses the global database handle.
func (o *Country) AddGeoZoneMatricesG(insert bool, related ...*GeoZoneMatrix) error {
...
// Sets related.R.Country appropriately.
// Panics on error.
func (o *Country) AddGeoZoneMatricesP(exec boil.Executor, insert bool, related ...*GeoZoneMatrix) {
...
// Sets related.R.Country appropriately.
// Uses the global database handle and panics on error.
func (o *Country) AddGeoZoneMatricesGP(insert bool, related ...*GeoZoneMatrix) {
...
// Appends related to o.R.GeoZoneMatrices.
// Sets related.R.Country appropriately.
func (o *Country) AddGeoZoneMatrices(exec boil.Executor, insert bool, related ...*GeoZoneMatrix) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.CountryID = o.ID
...
// AddRegionsG adds the given related objects to the existing relationships
// of the country, optionally inserting them as new records.
// Appends related to o.R.Regions.
// Sets related.R.Country appropriately.
// Uses the global database handle.
func (o *Country) AddRegionsG(insert bool, related ...*Region) error {
	return o.AddRegions(boil.GetDB(), insert, related...)
}

// AddRegionsP adds the given related objects to the existing relationships
// of the country, optionally inserting them as new records.
// Appends related to o.R.Regions.
// Sets related.R.Country appropriately.
// Panics on error.
func (o *Country) AddRegionsP(exec boil.Executor, insert bool, related ...*Region) {
	if err := o.AddRegions(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddRegionsGP adds the given related objects to the existing relationships
// of the country, optionally inserting them as new records.
// Appends related to o.R.Regions.
// Sets related.R.Country appropriately.
// Uses the global database handle and panics on error.
func (o *Country) AddRegionsGP(insert bool, related ...*Region) {
	if err := o.AddRegions(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Appends related to o.R.Regions.
// Sets related.R.Country appropriately.
func (o *Country) AddRegions(exec boil.Executor, insert bool, related ...*Region) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.CountryID = o.ID
...
func (o *Country) Update(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return errors.New("models: unable to update country, could not build whitelist")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to update country row")
	}
...
func (q countryQuery) UpdateAll(cols M) error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to update all for country")
	}
...
func (o *Country) Upsert(exec boil.Executor, updateColumns []string, whitelist ...string) error {
	...
	if !cached {
		...
		cache.retQuery = fmt.Sprintf(
			"SELECT %s FROM `country` WHERE `id`=?",
...
func (o *Country) Delete(exec boil.Executor) error {
	...
	_, err := exec.Exec(sql, args...)
	if err != nil {
		return errors.Wrap(err, "models: unable to delete from country")
	}
...
func (q countryQuery) DeleteAll() error {
	...
	_, err := q.Query.Exec()
	if err != nil {
		return errors.Wrap(err, "models: unable to delete all from country")
	}
